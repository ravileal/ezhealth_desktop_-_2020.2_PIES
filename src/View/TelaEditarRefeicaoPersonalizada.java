...
public class TelaEditarRefeicaoPersonalizada {
	...
	private void initialize() {
		...
		lblMinhaRefeio.setBounds(170, 104, 177, 30);
		...
		labelData.setBounds(170, 125, 92, 30);
		frame.getContentPane().add(labelData);

		JSeparator separator = new JSeparator();
		separator.setBounds(159, 166, 872, 2);
		...
		lblListaDeAlimentos.setBounds(170, 194, 141, 30);
		...
		lblAdicionarAlimentosNa.setBounds(677, 194, 354, 30);
		...
		textField.setBounds(677, 244, 335, 35);
...
//        }
		...
		scrollPane.setBounds(170, 235, 453, 260);
